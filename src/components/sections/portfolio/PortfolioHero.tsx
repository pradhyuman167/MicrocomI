    ...
    <section className="py-24 bg-[#0F0A1F] relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            My <span className="text-[#a5b4fc]">Creative</span>{" "}
            <span className="text-[#fda4af]">Projects</span>
          </motion.h1>
          ...
          >
            Explore my diverse portfolio of web development and design projects
          </motion.p>
        </div>
      </div>
    </section>
