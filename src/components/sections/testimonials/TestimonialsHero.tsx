    ...
    <section className="py-24 bg-[#0F0A1F] relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Our <span className="text-[#a5b4fc]">Clients</span> Share Their{" "}
            <span className="text-[#fda4af]">Success</span>
          </motion.h1>
          ...
          >
            Real stories from businesses that transformed their digital presence with our solutions.
          </motion.p>
        </div>
      </div>
    </section>
